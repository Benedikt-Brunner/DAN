...
for expected in baseline/manifest.json candidate/manifest.json baseline/index.sqlite candidate/index.sqlite report.md; do
...
cell_count="$(ls "$session"/baseline/cells/*.json 2>/dev/null | wc -l)"
